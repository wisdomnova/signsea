    ...
    <div className="min-h-screen bg-white text-black font-sans antialiased">
      ...
      <main className="pt-24 sm:pt-32 pb-20 sm:pb-24 px-4 sm:px-6">
        <div className="max-w-[800px] mx-auto">
          ...
          >
            <h1 className="text-[32px] sm:text-[48px] md:text-[84px] font-bold leading-[0.95] tracking-tighter mb-6 sm:mb-8 text-black">Privacy Policy.</h1>
            <p className="text-[12px] sm:text-[14px] font-bold text-gray-400 uppercase tracking-[0.2em]">Effective: May 13, 2026</p>
          </motion.header>
          ...
          <div className="space-y-16 sm:space-y-24 text-gray-600 text-base sm:text-lg leading-relaxed">
            ...
            >
              <h2 className="text-[20px] sm:text-[24px] font-bold text-black tracking-tight flex items-center gap-3 sm:gap-4">
                <span className="w-6 sm:w-8 h-[1px] bg-black flex-shrink-0" /> 01. Overview
              </h2>
              <p className="pl-9 sm:pl-12">
                SignSea provides industrial payment infrastructure. We operate a milestone-based escrow system where funds are held in secure wallets. This policy explains how we collect and process data in clinical environments.
              </p>
            </motion.section>
            ...
            >
              <h2 className="text-[20px] sm:text-[24px] font-bold text-black tracking-tight flex items-center gap-3 sm:gap-4">
                <span className="w-6 sm:w-8 h-[1px] bg-black flex-shrink-0" /> 02. Data Collection
              </h2>
              <div className="pl-9 sm:pl-12 space-y-4 sm:space-y-6">
                <p>
                  We collect technical identifiers required for escrow transactions:
                </p>
                <div className="grid gap-3 sm:gap-4">
                  {[
                    "Identity verification and KYC documentation.",
                    "Wallet addresses and transaction history.",
                    "Project milestones and communication logs.",
                    "Network metadata for security auditing."
                  ].map((item, i) => (
            ...
            >
              <h2 className="text-[20px] sm:text-[24px] font-bold text-black tracking-tight flex items-center gap-3 sm:gap-4">
                <span className="w-6 sm:w-8 h-[1px] bg-black flex-shrink-0" /> 03. Escrow Security
              </h2>
              <p className="pl-9 sm:pl-12">
                Funds are secured in isolated digital vaults. Access to transaction data is restricted to authorized entities and internal compliance protocols. We do not sell user data to third parties.
              </p>
            </motion.section>
            ...
            >
              <h2 className="text-[20px] sm:text-[24px] font-bold text-black tracking-tight flex items-center gap-3 sm:gap-4">
                <span className="w-6 sm:w-8 h-[1px] bg-black flex-shrink-0" /> 04. International Operations
              </h2>
              <p className="pl-9 sm:pl-12">
                We process transactions in NGN, USD, and GBP. Data storage complies with industrial standards for secure cross-border financial operations.
              </p>
            </motion.section>
